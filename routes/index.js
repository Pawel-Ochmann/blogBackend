...
router.post('/admin/comments/:comment_id', protected, adminController.comment_post);
router.delete('/admin/comments/:comment_id', protected, adminController.comment_delete);
...
router.delete('/admin/posts/:id', protected, adminController.post_detail_delete);
